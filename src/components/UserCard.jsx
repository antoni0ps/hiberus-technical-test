        ...
        <Card className='row mt-2 col-7 mx-auto'>
            {activeID !== id ?
                <Card.Body className='row justify-content-center'>
                    <span className='col-5 mx-auto '>{`${name} ${surname}`}</span>
                    <span className='col-5 mx-auto'>{`${email}`}</span>
                ...
                <Card.Body className='row justify-content-center'>
                    ...
                    <span className='col-2'><small className='text-success '>Usuario Activo</small></span>
                    <span className='col-1'><ModalUpdate id={id} name={name} surname={surname} email={email} setUsers={setUsers} /></span>
                </Card.Body>}
        </Card>
    );
